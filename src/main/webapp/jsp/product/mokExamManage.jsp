                            ...
                            <div id="section1">
                                <div class="col-md-auto">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 pl-0 pr-0">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="printQuestionFile"  name="printQuestionFile" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 pl-0 pr-0">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input addFile" id="printCommentaryFile" name="printCommentaryFile" required>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label col-form-label" style="margin-bottom: 0">링크 보여주기</label>
                                        <div class="col-sm-10">
                                            <div style="margin-top: -23px;" class="col-sm-5">
                                                OFF
                                                <label class="switch">
