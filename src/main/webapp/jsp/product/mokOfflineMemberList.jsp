...
<script>
    function init() {
        selectExamSearchSelectbox("l_searchSel","");
        ...
        productManageService.getMockExamListCount(searchType, searchText, function (cnt) {
            ...
            productManageService.getMockExamList(sPage, pagingListCount(), searchType, searchText, function (selList) {
                ...
                dwr.util.addRows("dataList", selList, [
                    function(data) {return "<a href='javascript:void(0);' style='float:left' color='blue' onclick='goModifyMockUserList(" + data.examKey + ");'>" +  data.name + "</a>";},
    ...
    function goModifyMockUserList(bankSubjectKey) {
        innerValue("param_key", bankSubjectKey);
        goPage("productManage","modifyMokUserList");
    }
        ...
        <div class="col-12">
            <div class="card">
                ...
                <table class="table table-hover">
                    <thead>
                    <tr>
                        <th scope="col" style="width: 45%;">시험명</th>
                        <th scope="col" style="width: 20%;">시험신청기간</th>
                        <th scope="col" style="width: 20%;">시험기간</th>
                        <th scope="col" style="width: 15%;">진행시간</th>
                    </tr>
                    </thead>
