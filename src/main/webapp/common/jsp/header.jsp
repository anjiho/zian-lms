            ...
            <ul class="navbar-nav mr-auto pt-3 pt-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-themes border-0 shadow animate slideIn" aria-labelledby="themesDropdown">
                        <div class="d-lg-flex flex-row float-left">
                            <div class="py-lg-3">
                                <a class="dropdown-item font-weight-bold" href=""><i class="far fa-paint-brush-alt fa-fw"></i>기본정보</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="">요약정보</a>
                                <a class="dropdown-item" href="">회사정보</a>
                                <a class="dropdown-item" href="">사이트정보</a>
                                <a class="dropdown-item" href="">이용약관</a>
                                <a class="dropdown-item" href="">개인정보 취급방침</a>
                                <a class="dropdown-item" href="">직원소개</a>
                            </div>
                        </div>
                        <div class="d-lg-flex flex-row">
                            <div class="py-lg-3">
                                <a class="dropdown-item font-weight-bold" href=""><i class="far fa-paint-brush-alt fa-fw"></i>배송정보</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="">배송사설정</a>
                            </div>
                        </div>
                    </div>
                </li>
...
<a class="dropdown-item disabled" href="#">Books <span class="ml-2 badge badge-pill badge-secondary d-lg-none">Under Development!</span></a>
            ...
            <ul class="navbar-nav pb-3 pb-lg-0">
                ...
                <li class="nav-item d-none d-lg-inline-block">
                    <a href="https://twitter.com/sbootstrap" class="nav-link text-twitter">
                        <i class="fab fa-twitter"></i>
                    </a>
                </li>
                <li class="nav-item d-none d-lg-inline-block">
                    <a href="https://github.com/blackrockdigital" class="nav-link text-github">
